...
# ====== ファイルパスを指定 ======
train_file = "../../data/SNOW/train.csv"  # 学習データファイル (CSV形式)
val_file = "../../data/SNOW/valid.csv"    # 検証データファイル (CSV形式)
...
# ====== トークナイザーとモデルの準備 ======
#以下は追加事前学習済みのBARTモデルを使用する場合
pretrained_model = "../../../SimpleBART/SNOW_mlm_output/checkpoint-○○"  # 日本語Simple_BARTモデル
...
training_args = TrainingArguments(
    output_dir="./../../train_Simple_BART",# 出力ディレクトリ
